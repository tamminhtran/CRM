...
public class TaskService {
	...
	public boolean addTask (String name, int idProject, int idUser, String startDate, String endDate) {
		int count = taskRepository.insert(name, idProject,idUser,startDate,endDate);
		return count>0;
	}
