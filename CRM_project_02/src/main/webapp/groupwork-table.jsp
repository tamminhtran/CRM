                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listgroupwork}">
                                        	<tr>
	                                            ...
	                                            <td>${item.endDate}</td>
	                                            <td>
	                                                <a href="<c:url value="/groupwork-update?groupworkId=${item.id}"/>" class="btn btn-sm btn-primary btn-update">Sửa</a>
	                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-groupwork="${item.id}">Xóa</a>
