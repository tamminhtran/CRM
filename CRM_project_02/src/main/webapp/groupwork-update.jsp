...
<body>
                        ...
                        <div class="white-box">
                            <form action="<c:url value= '/groupwork-update'/>" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="${groupwork.name}" name="groupwork-name"
                                            class="form-control form-control-line">
                                        <input type="hidden" name="id" value="${groupwork.id}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="${groupwork.startDate}" name="startDate" value="${groupwork.startDate}" 
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="${groupwork.endDate}" name="endDate" value="${groupwork.endDate}"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
    ...
    <script type="text/javascript" src="js/groupwork-update.js"></script>
</body>
