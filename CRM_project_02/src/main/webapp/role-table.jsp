...
<body>
                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${list}">
                                            ...
                                            <td>
                                                <a href="<c:url value= "/role-update?roleId=${item.id}" />" class="btn btn-sm btn-primary btn-update">Sửa</a>
    ...
    $(document).ready(function(){
    	...
    	$(".btn-xoa").click (function() {
    		var id = $(this).attr('id-role')         // let và var
    	...
    	$.ajax({
    	  method: "GET",
    	  url: `http://localhost:8080/CRM_project_02/api/role/delete?id=${id}`
