...
<body>
                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items ="${listTask}">
                                        	<tr>
                                            	...
                                            	<td>
                                                	<a href="<c:url value="/task-update?taskId=${item.id}"/>" class="btn btn-sm btn-primary btn-update" id-task="${item.id}">Sửa</a>
    ...
    <script type="text/javascript" src="js/task-table.js"></script>
</body>
</html>