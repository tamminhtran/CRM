...
<body>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<c:url value="/user-table" />" class="waves-effect"><i class="fa fa-modx fa-fw"
                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="item" items="${listUser}">
                                    	<tr>
                                            ...
                                            <td>
                                                <a href="<c:url value="/user-update?userId=${item.id}" />" class="btn btn-sm btn-primary btn-update">Sửa</a>
    ...
    <script type ="text/javascript" src="js/user-table.js"></script> <!-- import file user-table.js để sử dụng-->
</body>
